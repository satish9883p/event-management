  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-between">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-1 w-full space-y-8">
        ...
        {/* ================= Super Admin Control Center Banner (Admin Only) ================= */}
        {user?.role === 'admin' && (
          <div className="bg-gradient-to-r from-purple-900 via-indigo-900 to-purple-950 border border-purple-500/40 rounded-3xl p-6 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-5">
            <div className="space-y-1.5">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-0.5 rounded-full bg-purple-400/20 text-purple-200 text-xs font-black uppercase tracking-wider border border-purple-400/30">
                  👑 Super Admin Access Active
                </span>
                <span className="text-xs text-purple-300">Live Dynamic Controls</span>
              </div>
              <h3 className="text-xl font-black tracking-tight">Admin Event &amp; Venue Management</h3>
              <p className="text-purple-200 text-xs max-w-xl">
                You have full permissions to add, edit, or remove events, configure dynamic dates and time slots, manage function halls, and approve bookings.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-2.5">
              <Link to="/admin?tab=events">
                <Button size="sm" className="bg-purple-600 hover:bg-purple-500 font-bold text-xs shadow-md shadow-purple-500/20">
                  🎟️ Manage Events
                </Button>
              </Link>
              <Link to="/admin/events/new">
                <Button size="sm" className="bg-pink-600 hover:bg-pink-500 font-bold text-xs shadow-md shadow-pink-500/20">
                  ✨ + Create Dynamic Event
                </Button>
              </Link>
              <Link to="/admin">
                <Button size="sm" variant="outline" className="border-white/40 text-white hover:bg-white/10 font-bold text-xs">
                  👑 Open Admin Panel →
                </Button>
              </Link>
            </div>
