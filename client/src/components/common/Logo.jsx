  ...
  return (
    <div className={`flex items-center gap-2.5 ${className}`}>
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.96 }}
        className={`${iconSizes[size]} relative flex items-center justify-center rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-600 text-white shadow-md shadow-blue-500/25 flex-shrink-0`}
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
      ...
      <div className="flex flex-col leading-none">
        <div className="flex items-center gap-1.5">
          <span
            className={`${textSizes[size]} font-extrabold tracking-tight text-gray-900 dark:text-white`}
          >
            Event
          </span>
          <span
            className={`${textSizes[size]} font-black tracking-wider bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent`}
          >
            PRO
          </span>
        </div>
